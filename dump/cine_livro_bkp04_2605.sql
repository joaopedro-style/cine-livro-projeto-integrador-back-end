...
CREATE TABLE `usuarios` (
  ...
  `tipo` enum('admin','padrão') NOT NULL DEFAULT 'admin'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Ana Paula Ferreira', 'ana.ferreira@email.com', '$2y$10$4i4SIEiPo1Bx151xwsJWE.H3OQMCRJyrVf4tDGv28O8K6vFtTK886', '1990-03-12', 'admin'),
(2, 'Carlos Eduardo Lima', 'carlos.lima@email.com', '$2y$10$fxJ596B7MphNBmJ3fadYYu96KWYZk4lD6b5s6TdB4GTD.qXlCBWZ6', '1989-11-28', 'admin'),
(3, 'Júlia Mendes Rocha', 'julia.rocha@email.com', '$2y$10$28vp4r7yKKunEeF9uKxcTuuTHYMvI2uXefeaPj4FLhbZ6j5k.OIF6', '1995-07-05', 'admin'),
(4, 'Roberto da Silva Neto', 'roberto.silva@email.com', '$2y$10$JKP0z54vrHuGe08vDT4.muLAQy4dH7CQp36agqGeVFkjLVgEFlYTC', '1985-02-19', 'admin'),
(5, 'Mariana Costa Andrade', 'mariana.andrade@email.com', '$2y$10$W93T.qD88Ka2TFaQrnpp2.9Sx8ldsZZKkfjPk2ULiYWlu3EHEFrAe', '1993-09-23', 'admin'),
(15, 'João Pedro', 'joaopedro18231@hotmail.com', '$2y$10$4fLb2PsSj2oLogd69A.t/enY5MaUeljmood2acHiZGk4jBLH9nPte', '1997-01-26', 'padrão'),
(16, 'Tiago', 'tiago@gmail.com', '$2y$10$tNpEC1w83m9iN6TsvPOjR.KUuT8OTP6sKTDhyIpTl0vXxrgJcZEDm', '2025-05-27', 'admin'),
(17, 'Fulano', 'fulano@gmail.com', '$2y$10$de82qFdoDZrPRFed5QNYZeHNxyWxsYgkMGB4IbpTG5rclpQ.OM3E6', '2025-05-06', 'padrão'),
(18, 'pedro', 'Henrique1232@hotmail.com', '$2y$10$1KbDu4bvK/Xrw3s8dLt78Ow/eaU0ePGqCPRzqbRIaNFoV.TkZ8wLu', '1998-09-27', 'padrão');
