...
--
-- Host: 127.0.0.1
-- Tempo de geração: 03/06/2025 às 15:28
...
(2, 'Deadpool & Wolverine', 'David Leitch', '2024-07-25', 119, '18 anos', 'Wade Wilson, o Deadpool, volta para uma nova jornada ao lado de uma equipe de mutantes.', 'https://www.themoviedb.org/t/p/w600_and_h900_bestv2/xq4v7JE8niZ75OYYPDGNn6Gzpyt.jpg', 12, 2),
...
(4, 'Meu Malvado Favorito 4', 'Kyle Balda', '2024-07-04', 87, 'Livre', 'O filme é uma continuação da saga Meu Malvado Favorito, focando no crescimento do jovem Gru.', 'https://image.tmdb.org/t/p/w600_and_h900_face/jWYTtmxSuWVXP22hxAeXdQZLZrh.jpg', 12, 4),
...
(12, 'Dom Quixote', 'Miguel de Cervantes', '2023-09-25', 'Adulto', 'Dom Quixote, escrito pelo espanhol Miguel de Cervantes, é umclássico da literatura mundial e uma das obras mais influentesda história.', 'https://m.media-amazon.com/images/I/716YWt8LnCL._SL1419_.jpg', 12, 10);
...
(1, 'Ana Paula Ferreira', 'ana.ferreira@email.com', '$2y$10$vkUJLAigsy5Fosch.9fLR.og7bYvp4i5drB/MQkLPRrqFE7uQhueG', '1990-03-12', 'admin'),
(2, 'Carlos Eduardo Lima', 'carlos.lima@email.com', '$2y$10$0IVybq74mP/.a2phZA6vjOXOgZLBYanopcOrZxIXWXKAD8vkRc32q', '1989-11-28', 'admin'),
(3, 'Júlia Mendes Rocha', 'julia.rocha@email.com', '$2y$10$MbsJ0oEDhT9RJdo0CMzPm.GmoAb3aIkJDm01HGMPojj52vYIeKUmS', '1995-07-05', 'admin'),
(4, 'Roberto da Silva Neto', 'roberto.silva@email.com', '$2y$10$FnUxpBBSz6uoqXS.dSQSluMJk/P7LWtyGSYbImUzeEp9PDyQkMAK2', '1985-02-19', 'admin'),
(5, 'Mariana Costa Andrade', 'mariana.andrade@email.com', '$2y$10$B5V4LV.Zlh.nqA6ySZLEauXR2KcTYTmBV3ycTu99XpqIdFurk9Bw.', '1993-09-23', 'admin'),
